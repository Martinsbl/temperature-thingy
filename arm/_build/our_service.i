...
static uint32_t our_descriptor_add(ble_os_t * p_our_service, uint16_t char_handle)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 86, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0); 
    
    
        
    
    uint8_t attr_value[]  = "Kitchen";
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 105, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0); 
...
static uint32_t our_char_add(ble_os_t * p_our_service)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 126, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0);    
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 167, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0);   
    
    our_descriptor_add(p_our_service, p_our_service->char_handles.value_handle);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 170, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0);   
...
void our_service_init(ble_os_t * p_our_service)
{
    ...
    ble_uuid128_t     base_uuid = {0x23, 0xD1, 0x13, 0xEF, 0x5F, 0x78, 0x23, 0x15, 0xDE, 0xEF, 0x12, 0x12, 0x00, 0x00, 0x00, 0x00};
    service_uuid.uuid = 0xF00D;
    err_code = sd_ble_uuid_vs_add(&base_uuid, &service_uuid.type);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 190, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0);    
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 200, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0);
...
void our_characteristic_update(ble_os_t *p_os, int32_t * characteristic_value)
{
    ...
    {    
        if(*characteristic_value != previous_value)
        {
            ...
            {
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 237, (uint8_t*) "..\\our_service.c"); } while (0); } } while (0);
            }      
