...
#line 1 "..\\..\\..\\..\\..\\Include\\boards/pca20006.h"
...
volatile uint32_t battery_level;
_Bool do_battery_level_measurement = 0;



static void timer_timeout_handler_sensor(void * p_context)
{
    ...
    our_characteristic_update(&m_our_service, &temperature);    
}


static void timer_timeout_handler_battery(void * p_context)
{
    do_battery_level_measurement = 1; 
}
...
void app_error_handler(uint32_t error_code, uint32_t line_num, const uint8_t * p_file_name)
{
    ...
    volatile uint32_t lin = line_num;
    while(1);
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((4)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (4), (4) + 1, APP_TIMER_BUF, (1) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 224, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    uint32_t err_code;
    err_code = app_timer_create(&m_app_timer_battery_id, APP_TIMER_MODE_REPEATED, timer_timeout_handler_battery);
    ...
    err_code = app_timer_create(&m_app_timer_sensor_id, APP_TIMER_MODE_REPEATED, timer_timeout_handler_sensor);
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode,
                                          (const uint8_t *)"Kitchen",
                                          strlen("Kitchen"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 251, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 265, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
{
    do { app_error_handler((nrf_error), 365, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 388, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void timers_start(void)
{
    ...
    uint32_t err_code;
    err_code = app_timer_start(m_app_timer_battery_id, ((uint32_t)((((5000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0);
    ...
    err_code = app_timer_start(m_app_timer_sensor_id, ((uint32_t)((((1000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0);
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            ...
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 460, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            if (p_enc_info->div == p_ble_evt->evt.gap_evt.params.sec_info_request.div)
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 472, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            else
            {
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    ble_os_on_ble_evt(&m_our_service, p_ble_evt);
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 549, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 553, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    
    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 557, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
{
    do { static uint32_t APP_SCHED_BUF[((((((((sizeof(app_timer_event_t))) + 8) * (((10)) + 1))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_sched_init((sizeof(app_timer_event_t)), (10), APP_SCHED_BUF); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 565, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 598, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
int main(void)
{
    ...
    ((NRF_ADC_Type *) 0x40007000UL)->CONFIG = (( (0x02UL)                               << (0UL)) |
                        ((0x06UL)         << (2UL)) |
                        ((0x00UL)                              << (5UL)) |
                        ((0UL)                           << (8UL)) |
                        ((0UL)                          << (16UL)));
    ...
    for (;;)
    {
        app_sched_execute();
        power_manage();
        if(do_battery_level_measurement == 1)
        {
            
            ((NRF_ADC_Type *) 0x40007000UL)->TASKS_START = 1;
            ((NRF_ADC_Type *) 0x40007000UL)->ENABLE = 1;
            while(((NRF_ADC_Type *) 0x40007000UL)->BUSY);
            
            uint16_t adc_sample = ((NRF_ADC_Type *) 0x40007000UL)->RESULT;
            ...
            do_battery_level_measurement = 0;
        }
    }
}
